 ...
 * Tests the most critical aspects after schema introspection:
 * 1. Database connectivity
 * 2. Call record saving (core business function)
...
async function testCoreFunctionality() {
  ...
  try {
    ...
    // Test 2: Call record saving (core business function)
    console.log('2️⃣ Testing call record saving...');
      ...
      if (!testList) {
        testList = await prisma.dataList.create({
          data: {
            ...
            name: 'Test List',
            description: 'Test list for functionality testing',
            status: 'active',
            createdAt: new Date(),
            updatedAt: new Date()
          }
    ...
    console.log('✅ Call record saving: WORKING');
