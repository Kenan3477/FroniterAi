  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div>
          <div className="mx-auto h-12 w-12 flex items-center justify-center rounded-full bg-omnivox-100">
            <UserIcon className="h-8 w-8 text-omnivox-600" />
          </div>
          <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">
            Agent Login
          </h2>
          <p className="mt-2 text-center text-sm text-gray-600">
            Sign in to your Omnivox AI agent dashboard
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="mt-1 relative">
                <input
                  ...
                  className="appearance-none relative block w-full px-3 py-2 pl-10 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-omnivox-500 focus:border-omnivox-500"
          ...
          <div>
            <button
              ...
              className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-omnivox-600 hover:bg-omnivox-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-omnivox-500 disabled:opacity-50 disabled:cursor-not-allowed"
            >
