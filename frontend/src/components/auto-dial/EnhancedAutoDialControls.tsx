/**
 * Enhanced Auto-Dial Controls - Phase 3
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            <Label htmlFor="predictive-mode" className="flex items-center gap-2">
          ...
          <Switch
            ...
            onCheckedChange={setEnablePredictive}
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3 text-xs">
                <div className="space-y-1">
                  ...
                  <Progress 
                    value={predictiveStats.averageAnswerRate * 100} 
                    className="h-1" 
                  />
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <Progress 
                    value={predictiveStats.averageUtilization * 100} 
                    className="h-1" 
                  />
                </div>
              </div>
