      ...
      <div className="hidden lg:flex items-center space-x-4">
        ...
        <div className="flex items-center space-x-2">
          ...
          <select 
            ...
            className="text-sm border border-gray-300 rounded-md px-3 py-1 pr-8 bg-white focus:outline-none focus:ring-2 focus:ring-slate-500 focus:border-slate-500 disabled:bg-gray-100 disabled:text-gray-500 appearance-none min-w-[140px]"
            style={{
