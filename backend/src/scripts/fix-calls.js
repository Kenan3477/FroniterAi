...
async function fixRecentCalls() {
  ...
  try {
    // 1. Ensure DAC campaign exists first
    console.log('1. Ensuring DAC campaign exists...');
    ...
    // 2. Fix campaign assignments for calls that show as "manual-dial"
    console.log('\n2. Fixing campaign assignments...');
