...
const DEFAULT_DISPOSITIONS: DispositionConfig[] = [
  ...
  },
  {
    ...
    category: DispositionCategory.NEGATIVE,
    outcome: DispositionOutcome.FAILURE,
    description: 'Prospect was interested but declined at final closing',
    requiresNotes: true,
    requiresCallback: false,
    allowedNextSteps: ['follow_up', 'nurture'],
    color: '#F97316',
    ...
    sortOrder: 21,
    campaignSpecific: false,
    metadata: { closeAttempted: true }
  },
  {
    id: 'has_cover_not_interested',
    label: 'Has Cover Not Interested',
    type: DispositionType.NOT_INTERESTED,
    category: DispositionCategory.NEGATIVE,
    outcome: DispositionOutcome.FAILURE,
    description: 'Contact already has coverage and is not interested',
    requiresNotes: false,
    requiresCallback: false,
    allowedNextSteps: ['remove', 'future_review'],
    color: '#6B7280',
    icon: 'shield',
    isActive: true,
    sortOrder: 22,
    campaignSpecific: false,
    metadata: { hasCoverage: true }
  },
  {
    id: 'do_not_call',
    label: 'Do Not Call',
