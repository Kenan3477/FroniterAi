/**
 * Shared rules for dashboard call counts (stats + charts).
 */
...
/** Used for performance charts — includes short in-progress rows. */
...
/** Matches `/api/dashboard/stats` "connected today" — ended call that clearly had a conversation or disposition. */
...
/** Sale / positive outcome for "sales today" KPI — outcome string or disposition name. */
