...
===============================
Externalizes hardcoded values from check_deployment
...
class ConfigurationManager:
    """Manages externalized configuration for check_deployment"""
    
    def __init__(self, config_file: str = "check_deployment_config.json"):
